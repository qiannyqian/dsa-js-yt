...
function maxChar(str) {
  ...
  //Fill character count object
  for (let i = 0; i < str.length; i++) {
    const char = str[i];

    //If we come across character, make key value pair have value of 1. if we came across it again, add 1 to key value pair count
    charCountObj[char] = charCountObj[char] + 1 || 1;

    //reassign variables of maxChar and maxCount
